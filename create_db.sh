...
curl -s -X POST -H "Auth-Token: $api_key" -d '{"alert_key":"testing.alert_key","escalation_id":1,"failure_time":300,"max_failures":5,"failure_expiration":60}' $base_url/api/alert/ | python -m json.tool
